...
public class Ws_unad_minticPortTypeProxy implements localhost.WebServices.servicioweb_mintic.Ws_unad_minticPortType {
  private String _endpoint = null;
  private localhost.WebServices.servicioweb_mintic.Ws_unad_minticPortType ws_unad_minticPortType = null;
  ...
  private void _initWs_unad_minticPortTypeProxy() {
    try {
      ws_unad_minticPortType = (new localhost.WebServices.servicioweb_mintic.Ws_unad_minticLocator()).getws_unad_minticPort();
  ...
  public localhost.WebServices.servicioweb_mintic.Ws_unad_minticPortType getWs_unad_minticPortType() {
    if (ws_unad_minticPortType == null)
      _initWs_unad_minticPortTypeProxy();
